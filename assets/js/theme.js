...
const span = document.getElementById("section5");
span.style.top = document.body.offsetHeight - document.getElementById("footer").offsetHeight - window.innerHeight + "px";
